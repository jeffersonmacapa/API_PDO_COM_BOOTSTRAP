...
<div class="h4 pb-2 mb-4 text-primary border-bottom border-primary text-center">
  ...
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" name="nome" placeholder="Nome do cliente" >
  </div>
  <br>
  <div class="input-group input-group-lg">
  <span class="input-group-text" id="inputGroup-sizing-lg">Endereço</span>
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" name="teste" placeholder="Endereço do cliente" >  
</div>
<hr>
  <button type="submit" class="btn btn-primary" name="salvar">Cadastrar</button>
</form>
    <a href='exibir.php'>
    <button type="button" class="btn btn-primary">Exibir Cadastros</button></a>  
  </div>
</div>
